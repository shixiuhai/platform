...
) ENGINE = InnoDB AUTO_INCREMENT = 26 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台用户表' ROW_FORMAT = Dynamic;
...
INSERT INTO `ums_admin` VALUES (23, 'owQK84qWk9w5qWYE4bpkl1sHJkL81', '$2a$10$/3.YGGvSDnUkO.5cq9NKYuuzbsl.GmDhg3hxMzX.u9j6OS2C94Y/y', NULL, NULL, NULL, NULL, NULL, '2023-06-18 19:32:07', NULL, 1);
...
CREATE TABLE `ums_admin_login_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 344 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台用户登录日志表' ROW_FORMAT = Dynamic;
...
INSERT INTO `ums_admin_login_log` VALUES (332, 3, '2023-06-18 16:14:38', '127.0.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (333, 3, '2023-06-18 16:25:56', '127.0.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (334, 3, '2023-06-18 16:25:58', '127.0.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (335, 3, '2023-06-18 16:26:01', '127.0.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (336, 3, '2023-06-18 16:26:03', '127.0.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (337, 3, '2023-06-18 16:27:02', '127.0.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (338, 3, '2023-06-18 16:29:16', '127.0.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (339, 3, '2023-06-19 19:45:40', '127.0.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (340, 3, '2023-06-19 21:02:04', '127.0.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (341, 3, '2023-06-19 21:39:21', '127.0.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (342, 18, '2023-06-19 21:42:11', '127.0.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (343, 3, '2023-06-19 21:46:41', '127.0.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (344, 3, '2023-06-19 23:53:40', '127.0.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (345, 18, '2023-06-20 00:03:04', '127.0.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (346, 18, '2023-06-20 00:04:46', '127.0.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (347, 18, '2023-06-20 00:27:29', '127.0.0.1', NULL, NULL);
INSERT INTO `ums_admin_login_log` VALUES (348, 26, '2023-06-20 00:39:13', '127.0.0.1', NULL, NULL);
...
CREATE TABLE `ums_admin_role_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 50 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台用户和角色关系表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_business_anchor_detail`  (
  `id` bigint(0) NOT NULL AUTO_INCREMENT,
  `anchor_id` bigint(0) NOT NULL COMMENT '主持人id',
...
CREATE TABLE `ums_business_work`  (
  ...
  `img_url` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '作品图片',
  `video_url` text CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL COMMENT '作品视频',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '作品表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of ums_business_work
-- ----------------------------
INSERT INTO `ums_business_work` VALUES (1, 19, '小海', NULL, '测试作品名字', NULL, 31, '2023-05-18 22:49:12', 1, NULL, NULL, NULL);
INSERT INTO `ums_business_work` VALUES (2, 3, '管理员（这里的nickname是真实的主持人名称和用户名称前面的username是账号和后面接口查询出来的username无关）', '作品封面图片地址', '作品标题', '作品地点', 9, '2023-06-18 15:50:48', 1, NULL, NULL, NULL);
...
INSERT INTO `ums_business_work` VALUES (4, 3, '管理员（username是账号）', '作品封面图片地址', '作品标题或者动态标题', '作品地点', 0, '2023-06-18 20:14:39', 1, '动态内容,当type为1时设置为空表示发布作品,type为2时设置主持人发布的动态内容', 'url1,url2', 'url1,url2');
...
CREATE TABLE `ums_business_workimg`  (
  ...
  `type` int(0) NULL DEFAULT NULL COMMENT '作品类型，1婚礼作品，2主持人动态',
  `video_url` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '作品视频',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `ums_business_workimg` VALUES (1, 2, 'http://2.jpg', 1, NULL);
INSERT INTO `ums_business_workimg` VALUES (2, 2, 'http://22w.bai', 2, NULL);
INSERT INTO `ums_business_workimg` VALUES (3, 1, 'http://sdfa', 1, NULL);
INSERT INTO `ums_business_workimg` VALUES (4, 1, '/abcd/1.png', 1, NULL);
...
CREATE TABLE `ums_business_workstar`  (
  ...
  `type` int(0) NULL DEFAULT NULL COMMENT '1婚礼作品点赞，2主持人动态点赞，3.婚礼作品评论点赞, 4 主持人动态评论点赞, 5婚礼作品收藏,6主持人动态收藏',
  `comment_id` int(0) NULL DEFAULT NULL COMMENT '评论id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin COMMENT = '点赞收藏表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ums_resource`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 37 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台资源表' ROW_FORMAT = Dynamic;
...
INSERT INTO `ums_resource` VALUES (37, '2023-06-19 23:46:28', '用户更新自己信息', '/admin/update/myself', NULL, 5);
...
CREATE TABLE `ums_role_resource_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 234 CHARACTER SET = utf8mb3 COLLATE = utf8mb3_general_ci COMMENT = '后台角色资源关系表' ROW_FORMAT = Dynamic;
